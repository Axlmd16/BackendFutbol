...
class AthleteInscriptionDTO(PersonBase):
    ...
    height: Optional[float] = Field(default=None, ge=0, description="Altura en metros (no puede ser negativa)")
...
class MinorAthleteDataDTO(BaseModel):
    ...
    sex: SexInput = Field(default=SexInput.MALE, description="Sexo")
    height: Optional[float] = Field(default=None, ge=0, le=1.75, description="Altura en metros (máximo 1.75 m)")
